...
resource "azurerm_management_group" "platform" {
  name                       = "mg-${var.prefix}-platform-${var.location}"
...
resource "azurerm_management_group" "connectivity" {
  ...
  name                       = "mg-${var.prefix}-connectivity-${var.location}"
...
resource "azurerm_management_group" "management" {
  name                       = "mg-${var.prefix}-management-${var.location}"
...
resource "azurerm_management_group" "identity" {
  name                       = "mg-${var.prefix}-identity-${var.location}"
...
resource "azurerm_management_group" "sandboxes" {
  name                       = "mg-${var.prefix}-sandboxes-${var.location}"
...
resource "azurerm_management_group" "decommissioned" {
  name                       = "mg-${var.prefix}-decommissioned-${var.location}"
...
resource "azurerm_management_group" "landing_zones" {
  name                       = "mg-${var.prefix}-landing-zones-${var.location}"
...
resource "azurerm_management_group" "shared_svc" {
  name                       = "mg-${var.prefix}-shared-svc-${var.location}"
...
resource "azurerm_management_group" "dynamic" {
  ...
  name                       = "mg-${var.prefix}-${each.key}-${var.location}"
